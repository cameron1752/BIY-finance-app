...
class TransactionsControllerTest {
    ...
    void getTransactions_withoutId_returnsAllTransactionsForAccount() throws Exception {
        ...
        when(transactionsService.getAllTransactions(ACCOUNT_ID)).thenReturn(transactions);
        ...
        verify(transactionsService, times(1)).getAllTransactions(ACCOUNT_ID);
    ...
    void getTransactions_withId_returnsSingleTransaction() throws Exception {
        ...
        verify(transactionsService, never()).getAllTransactions(anyString());
    }
    ...
    void getTransactions_serviceThrowsException_returnsServerError() throws Exception {
        when(transactionsService.getAllTransactions(ACCOUNT_ID))
